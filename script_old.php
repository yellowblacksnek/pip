...
<body class="background">
	<header>Венщиков Марат, P3201<br>
	Вариант 201004</header>
	...
	<main class="animated zoomIn fast">
        <div style="font-size: 16px;">Время исполнения: 
                
                    <?php
                    echo number_format((microtime(true) - $_SERVER["REQUEST_TIME_FLOAT"]) * 1000000, 2, ",", ".") . " мкс";
                    ?>
        </div>   
        <div style="font-size: 16px;">Текущее время: 
                <span id="time"></span>
        ...
        <table class="tableResponse" cellspacing="15">
            <tbody>
                    <tr>
                        <th colspan="3" style="text-align: center">Введённые данные</th>
                    </tr>
                    ...
                    <td colspan="3" style="text-align: center">
                        ...
                        if ($rightNumbers && $correctInput) {
                            echo '<span style="color:#008000;">попадание</span>';
                        } elseif ($correctInput) {
                            echo '<span style="color:#B22222;">промах</span>';
                        } else {
                            echo '<span style="color:#B22222;">данные неверны</span>';
                        }
                        ?>
                        <script type="text/javascript">
                            setDotCoordResponse();
        ...
        <p style="text-align: center;"><a href="index2.html" class="btn" id="okBtn" onclick="okPressed()">Понятно</a></p>
